...
var TimerMode = /* @__PURE__ */ ((TimerMode2) => {
  TimerMode2[TimerMode2["positive"] = 0] = "positive";
  TimerMode2[TimerMode2["reverse"] = 1] = "reverse";
  TimerMode2[TimerMode2["nomal"] = 2] = "nomal";
  return TimerMode2;
})(TimerMode || {});
const createTray = (mainWindow) => {
  const tray = new require$$3.Tray(
    path.resolve(
      __dirname,
      process.platform == "darwin" ? "../../resources/IconTemplate@2x.png" : "../../resources/IconTemplate@2x.png"
    )
  );
  const contextMenu = require$$3.Menu.buildFromTemplate([
    {
      label: "计时模式",
      submenu: [
        {
    ...
    {
      label: "见万事如流",
      click: () => require$$3.shell.openExternal("http://www.chenyx.site")
    },
    { label: "退出", role: "quit" }
  ]);
...
const getWin = (event) => {
  return require$$3.BrowserWindow.fromWebContents(event.sender);
};
...
const icon = path.join(__dirname, "../../resources/IconTemplate@2x.png");
...
const remote = /* @__PURE__ */ getDefaultExportFromCjs(mainExports);
...
require$$3.app.whenReady().then(() => {
  utils.electronApp.setAppUserModelId("cyx.clock");
